...
module LFSR_TX #(
    ...
    // o_valid_frame_en is now assigned sequentially in the always block to align with o_ser_en_lfsr
        ...
        if (!i_rst_n) begin
            ...
            case (current_state)
                ...
                IDLE: begin
                    ...
                    // Disable lane reversal in TX LFSR because it is handled at the pad/channel level
                    lane_reversal_enabled <= 0; // i_reversal_en;
