...
module MB_RX_TOP #(
    ...
    // =========================================================================
    // -------------------------------------------------------------------------
    // CLK_PATTERN_DETECTOR_RX is driven by pll_clk (fast clock) because
    // clk_p / clk_n / track toggle at pll_clk rate.  Using MB_clk (=pll/16)
    // would alias the pattern and never assert pass.
    // -------------------------------------------------------------------------
