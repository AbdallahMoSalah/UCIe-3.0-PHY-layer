...
module RX_Deser_TB_s3;
    ...
    Valid_Deserializer_s3 #(.DATA_WIDTH(DATA_WIDTH)) u_valid_des (
    ...
    Data_Deserializer_s3 #(.DATA_WIDTH(DATA_WIDTH)) u_data_des (
        .mb_clk              (mb_clk),
        .pll_clk             (rx_pll_clk), // Use delayed clock
        .i_rst_n             (rst_n),
