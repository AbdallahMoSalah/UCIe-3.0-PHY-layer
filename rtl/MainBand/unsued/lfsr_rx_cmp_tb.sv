...
//             o_final_gene[0] must equal lfsr_serial agg_word, word-for-word,
...
module lfsr_rx_cmp_tb;
    ...
    initial begin
        ...
        // ---- TEST 1 compare ----
        $display("\n===========================================================");
        $display("  TEST 1 : RX o_final_gene[0]  vs  lfsr_serial agg_word");
