...
module RX_Deser_TB_s2;
    ...
    Valid_Deserializer_s2 #(.DATA_WIDTH(DATA_WIDTH)) u_valid_des (
    ...
    Data_Deserializer_s2 #(.DATA_WIDTH(DATA_WIDTH)) u_data_des (
        .mb_clk              (mb_clk),
        .pll_clk             (rx_pll_clk), // Use delayed clock
        .i_rst_n             (rst_n),
