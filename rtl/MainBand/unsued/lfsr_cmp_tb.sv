...
module lfsr_cmp_tb;
    ...
    initial begin
        ...
        rst_n = 1'b1;
        @(posedge clk);   // LFSR_TX now holds seed in tx_lfsr[]; frozen in IDLE
        ...
        // COMPARE
        // =====================================================================
        $display("\n  win |  serial agg_word | LFSR_TX o_lane[0] | result");
        $display("  ----+------------------+-------------------+-------");
        mism = 0;
