...
module unit_rx_deser_tb_s1;
    ...
    unit_valid_deserializer_s1 #(.DATA_WIDTH(8)) u_valid_des (
    ...
    unit_data_deserializer_s1 #(.DATA_WIDTH(DATA_WIDTH)) u_data_des (
        .mb_clk              (mb_clk),
        .pll_clk             (rx_pll_clk), // Use delayed clock
        .i_rst_n             (rst_n),
    ...
    initial begin
        ...
        $dumpvars(0, unit_rx_deser_tb_s1);
