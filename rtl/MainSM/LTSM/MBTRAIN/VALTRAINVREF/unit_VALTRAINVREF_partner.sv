...
module unit_VALTRAINVREF_partner (
    ...
    VALTRAINVREF_PTR_TO_DATATRAIN1   = 4'd5,  // Terminal: completed (next DTC1)
    ...
    always_comb begin : NEXT_STATE_PROC
        ...
        if (timeout_8ms_occured ||
        ...
        else if (!valtrainvref_en &&
                 current_state != VALTRAINVREF_PTR_TO_DATATRAIN1 &&
                 current_state != VALTRAINVREF_PTR_TO_TRAINERROR) begin
            ...
            case (current_state)
                ...
                VALTRAINVREF_PTR_SEND_END_RESP: begin
                    next_state = VALTRAINVREF_PTR_TO_DATATRAIN1;
                end

                VALTRAINVREF_PTR_TO_DATATRAIN1: begin
                    next_state = valtrainvref_en ? VALTRAINVREF_PTR_TO_DATATRAIN1 : VALTRAINVREF_PTR_IDLE;
                end
