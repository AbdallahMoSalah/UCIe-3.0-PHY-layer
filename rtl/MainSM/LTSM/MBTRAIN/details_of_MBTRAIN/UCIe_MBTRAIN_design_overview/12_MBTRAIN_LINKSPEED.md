...
LINKSPEED_LCL_TO_LINKINIT -->|"linkspeed_en == 0"| END1
LINKSPEED_LCL_TO_REPAIR -->|"linkspeed_en == 0"| END1
LINKSPEED_LCL_TO_SPEEDIDLE -->|"linkspeed_en == 0"| END1
LINKSPEED_LCL_TO_PHYRETRAIN -->|"linkspeed_en == 0"| END1
```
...
LINKSPEED_PTR_TO_LINKINIT -->|"linkspeed_en == 0"| END2
LINKSPEED_PTR_TO_REPAIR -->|"linkspeed_en == 0"| END2
LINKSPEED_PTR_TO_SPEEDIDLE -->|"linkspeed_en == 0"| END2
LINKSPEED_PTR_TO_PHYRETRAIN -->|"linkspeed_en == 0"| END2
```
