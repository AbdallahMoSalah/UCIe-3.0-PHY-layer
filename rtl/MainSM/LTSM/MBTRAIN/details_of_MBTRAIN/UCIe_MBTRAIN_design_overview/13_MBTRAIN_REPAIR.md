...
REPAIR_LCL_TO_TXSELFCAL -->|"repair_en == 0"| END1
REPAIR_LCL_TO_TRAINERROR -->|"repair_en == 0"| END1
```
...
REPAIR_PTR_DONE -->|"repair_en == 0"| END2
REPAIR_PTR_TO_TRAINERROR -->|"repair_en == 0"| END2
```
