...
module unit_DATATRAINCENTER1_local #(
        ...
        // Spec §4.5.3.4.8:
        //   - Clock TX: active.
        //   - Data TX: Active (sending patterns during PT).
        //   - Valid TX: Active (sending patterns during PT).
        //   - Track TX: held low.
        //   - RX lanes: enabled.
    ...
    always_comb begin : OUTPUT_COMB
        ...
        // MB lane defaults
        mb_tx_clk_lane_sel  = 2'b01; // Active
        mb_tx_data_lane_sel = 2'b00; // Low (driven by D2C PT during sweep)
        mb_tx_val_lane_sel  = 2'b00; // Low
        mb_tx_trk_lane_sel  = 2'b00; // Low
