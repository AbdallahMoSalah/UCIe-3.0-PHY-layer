...
module wrapper_DATATRAINCENTER1 #(
        ...
        input  logic        datatraincenter1_en,
    ...
    unit_DATATRAINCENTER1_local #(
        ...
        .lclk                           (lclk),
        .rst_n                          (rst_n),
        .datatraincenter1_en            (datatraincenter1_en),
    ...
    // =========================================================================
    assign mb_tx_clk_lane_sel  = 2'b01; // TX CLK always active during DTC1
    assign mb_tx_data_lane_sel = 2'b00; // Held low (TX D2C PT drives data)
