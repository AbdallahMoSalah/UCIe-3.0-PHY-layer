...
module wrapper_DATATRAINCENTER1 #(
    ...
    unit_DATATRAINCENTER1_local #(
        ...
        .datatraincenter1_done          (local_datatraincenter1_done),
    ...
    unit_DATATRAINCENTER1_partner u_partner (
        ...
        .is_ltsm_out_of_reset           (is_ltsm_out_of_reset),
        .timeout_8ms_occured            (timeout_8ms_occured),
        .datatraincenter1_done          (partner_datatraincenter1_done),
