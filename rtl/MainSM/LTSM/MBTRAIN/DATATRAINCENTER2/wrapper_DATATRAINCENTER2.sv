// wrapper_DATATRAINCENTER2.sv — MBTRAIN.DATATRAINCENTER2 Wrapper
//
// This module wraps both the Local (Initiator) and Partner (Responder) FSMs of the DATATRAINCENTER2 substate.
// It arbitrates their Sideband (SB) TX outputs and multiplexes their Mainband (MB) control outputs.

module wrapper_DATATRAINCENTER2 #(
    ...
    unit_DATATRAINCENTER2_local #(
        .MAX_DATA_PI_CODE(MAX_DATA_PI_CODE)
    ) u_local (
        .lclk                           (lclk),
        .rst_n                          (rst_n),
        .datatraincenter2_en            (datatraincenter2_en),
    ...
    unit_DATATRAINCENTER2_partner u_partner (
        .lclk                           (lclk),
        .rst_n                          (rst_n),
        .datatraincenter2_en            (datatraincenter2_en),
        .soft_rst_n                     (soft_rst_n),
    ...
    // =========================================================================
    // MB Lane Assignments — Static per spec §4.5.3.4.11 MBTRAIN.DATATRAINCENTER2:
    //   Local   (TX side): CLK TX active (01), DATA/VAL/TRK TX held low.
