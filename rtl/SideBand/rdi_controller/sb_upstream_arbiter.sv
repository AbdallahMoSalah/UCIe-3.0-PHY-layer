...
module sb_upstream_arbiter (
    ...
    // ==========================================
    // Note: No 'ready' output is provided here as the Link Controller operates 
    ...
    // ==========================================
    // Local completions use standard valid/ready handshaking.
    input  logic [127:0] completion_msg,    // Local Completion Data
    input  logic         completion_vld,    // Local Completion Valid
    output logic         completion_ready,  // Backpressure to Reg_access
    ...
    // ==========================================
    // Task 3: Low-Priority Backpressure (Ready Logic)
    // ==========================================
    // Grant a 'ready' signal to the local Reg_access ONLY if:
    ...
    assign completion_ready = completion_vld & (~Adapter_vld_rcvd);
