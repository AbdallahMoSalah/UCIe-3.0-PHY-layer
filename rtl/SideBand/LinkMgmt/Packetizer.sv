...
always_comb begin
    ...
    header_comb.MsgInfo     = msg_info_send;
    is_there_data           = 0;
    ...
    if (msg_no_send >= RDI_ACTIVE_REQ && msg_no_send <= RDI_PMNAK_RSP && msg_no_send != NOP) begin
        ...
        // subcode mapping
        case (msg_no_send)
            RDI_ACTIVE_REQ, RDI_ACTIVE_RSP:         header_comb.MsgSubcode = 8'h01;
            RDI_PMNAK_RSP:                          header_comb.MsgSubcode = 8'h02;
            RDI_L1_REQ, RDI_L1_RSP:                 header_comb.MsgSubcode = 8'h04;
            RDI_L2_REQ, RDI_L2_RSP:                 header_comb.MsgSubcode = 8'h08;
            RDI_LINK_RESET_REQ, RDI_LINK_RESET_RSP: header_comb.MsgSubcode = 8'h09;
            RDI_LINK_ERROR_REQ, RDI_LINK_ERROR_RSP: header_comb.MsgSubcode = 8'h0A;
            RDI_RETRAIN_REQ, RDI_RETRAIN_RSP:       header_comb.MsgSubcode = 8'h0B;
            RDI_DISABLE_REQ, RDI_DISABLE_RSP:       header_comb.MsgSubcode = 8'h0C;
        endcase
    ...
    header_comb.dp = is_there_data? ^msg_data_send : 0 ;
    header_comb.opcode = is_there_data ? SB_MSG_WITH_64_DATA : SB_MSG_WITHOUT_DATA;
    header_comb.cp = ^(62'(header_comb[61:0])); 
