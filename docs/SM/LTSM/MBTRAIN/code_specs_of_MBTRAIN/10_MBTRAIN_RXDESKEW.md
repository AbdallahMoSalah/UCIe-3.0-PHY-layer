...
RXDESKEW_LCL_WAIT_EXIT_DTC1_RESP -->|"rx_sb_msg == exit_to_DTC1_req && partner_arc_cnt == 4 (Global Override)"| RXDESKEW_LCL_TO_TRAINERROR
RXDESKEW_LCL_TO_DTC2 -->|"rxdeskew_en == 0"| RXDESKEW_LCL_IDLE
RXDESKEW_LCL_TO_DTC1 -->|"rxdeskew_en == 0"| RXDESKEW_LCL_IDLE
RXDESKEW_LCL_TO_TRAINERROR -->|"rxdeskew_en == 0"| RXDESKEW_LCL_IDLE
```
...
RXDESKEW_PTR_TO_DTC2 -->|"rxdeskew_en == 0"| RXDESKEW_PTR_IDLE
RXDESKEW_PTR_TO_DTC1 -->|"rxdeskew_en == 0"| RXDESKEW_PTR_IDLE
RXDESKEW_PTR_TO_TRAINERROR -->|"rxdeskew_en == 0"| RXDESKEW_PTR_IDLE
```
