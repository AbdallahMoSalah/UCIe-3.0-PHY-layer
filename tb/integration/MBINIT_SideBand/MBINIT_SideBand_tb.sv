...
module MBINIT_SideBand_tb;
    ...
    // =========================================================================
    always @(u_mbinit_0.u_mbinit_wrapper.u_controller.current_state) begin
        $display("T=%0t | [DIE 0 CONTROLLER] State: %s", $time, u_mbinit_0.u_mbinit_wrapper.u_controller.current_state.name());
    end

    always @(u_mbinit_1.u_mbinit_wrapper.u_controller.current_state) begin
        $display("T=%0t | [DIE 1 CONTROLLER] State: %s", $time, u_mbinit_1.u_mbinit_wrapper.u_controller.current_state.name());
    end
