...
module Logical_PHY_tb;
    ...
    logic                 stall_done0,   stall_done1;
    logic                 clk_hs_done0,  clk_hs_done1;
    ...
    Logical_PHY #(.CLK_FRQ_HZ(LTSM_CLK_FRQ), .NUM_LANES(NUM_LANES)) u_die0 (
        ...
        .i_pcmp_thr_per_lane(16'd100), .i_pcmp_thr_aggregate(16'd1000), .i_vcmp_thr(16'd50),
        .lclk(lclk0), .o_pll_clk(), .o_out_data(o_out_data0), .o_pl_valid(o_pl_valid0), .o_pcmp_agg_err_cnt(),
        ...
        .current_ltsm_state(), .current_ltsm_state_n(ln0),
        .log0_state_n(), .log0_lane_reversal(), .log0_width_degrade(),
        .log0_state_n_minus_1(), .log0_state_n_minus_2(), .log1_state_n_minus_3(),
        .phy_start_ucie_link_training_ctrl_out(phy_start0), .Adapter_training_req(1'b0), .SPMW(1'b0),
        ...
        .clk_handshake_done(clk_hs_done0), .stall_done(stall_done0),
    ...
    Logical_PHY #(.CLK_FRQ_HZ(LTSM_CLK_FRQ), .NUM_LANES(NUM_LANES)) u_die1 (
        ...
        .i_pll_speed_sel(2'b00),
        .i_pcmp_thr_per_lane(16'd100), .i_pcmp_thr_aggregate(16'd1000), .i_vcmp_thr(16'd50),
        .lclk(lclk1), .o_pll_clk(), .o_out_data(o_out_data1), .o_pl_valid(o_pl_valid1), .o_pcmp_agg_err_cnt(),
        ...
        .rf_addr(), .rf_be(), .rf_is_64b_access(), .rf_wdata(), .rd_en(), .wr_en(),
        .rf_rdata(64'h0), .rdata_vld(1'b0), .addr_err_o(1'b0),
        .current_ltsm_state(), .current_ltsm_state_n(ln1),
        .log0_state_n(), .log0_lane_reversal(), .log0_width_degrade(),
        .log0_state_n_minus_1(), .log0_state_n_minus_2(), .log1_state_n_minus_3(),
        .phy_start_ucie_link_training_ctrl_out(phy_start1), .Adapter_training_req(1'b0), .SPMW(1'b0),
        .reg_phy_x8_mode_ctrl(1'b0),
        .reg_TARR_support_local_cap(1'b1), .reg_L2SPD_support_local_cap(1'b1),
        .reg_PSPT_support_local_cap(1'b1), .reg_PMO_support_local_cap(1'b0),
        .reg_Max_Link_Speed_cap(4'b0101), .reg_Supported_TX_Vswing(5'b00111),
        ...
        .clk_handshake_done(clk_hs_done1), .stall_done(stall_done1),
        .UCIe_Link_DVSEC_UCIe_Link_Capability_7to4(4'h0),
        .UCIe_Link_DVSEC_UCIe_Link_Status_17to11(4'h0),
        .UCIe_Link_DVSEC_UCIe_Link_Status_10to7(4'h0)
    );
    ...
    initial begin
        ...
        $display("T=%0t | [SC3] ACTIVE. Requesting L1 on both dies...", $time);
        @(negedge lclk0);
        lp_state_req0 = L_1; lp_state_req1 = L_1;
        fork
