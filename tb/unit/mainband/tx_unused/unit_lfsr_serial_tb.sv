// =============================================================================
// Testbench : unit_lfsr_serial_tb
// Verifies  : unit_lfsr_serial module per UCIe 3.0 §4.4.1
//
// Test plan:
...
module unit_lfsr_serial_tb;
    ...
    initial begin
        $display("===========================================================");
        $display("  unit_lfsr_serial Testbench — UCIe 3.0 §4.4.1 Verification");
        $display("===========================================================");
        total_errors = 0;
