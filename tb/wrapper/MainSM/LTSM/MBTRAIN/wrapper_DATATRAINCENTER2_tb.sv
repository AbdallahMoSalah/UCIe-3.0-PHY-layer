...
module wrapper_DATATRAINCENTER2_tb;
    ...
    typedef enum reg [3:0] {
        TB_DATATRAINCENTER2_LCL_IDLE           = 4'd0,
        TB_DATATRAINCENTER2_LCL_SEND_START_REQ = 4'd1,
        TB_DATATRAINCENTER2_LCL_WAIT_START_RESP= 4'd2,
        TB_DATATRAINCENTER2_LCL_SWEEP          = 4'd3,
        TB_DATATRAINCENTER2_LCL_APPLY_BEST     = 4'd4,
        TB_DATATRAINCENTER2_LCL_SEND_END_REQ   = 4'd5,
        TB_DATATRAINCENTER2_LCL_WAIT_END_RESP  = 4'd6,
        TB_DATATRAINCENTER2_LCL_TO_LINKSPEED   = 4'd7,
        TB_DATATRAINCENTER2_LCL_TO_TRAINERROR  = 4'd8
    } tb_local_state_t;

    typedef enum reg [3:0] {
        TB_DATATRAINCENTER2_PTR_IDLE            = 4'd0,
        TB_DATATRAINCENTER2_PTR_WAIT_START_REQ  = 4'd1,
        TB_DATATRAINCENTER2_PTR_SEND_START_RESP = 4'd2,
        TB_DATATRAINCENTER2_PTR_WAIT_END_REQ    = 4'd3,
        TB_DATATRAINCENTER2_PTR_SEND_END_RESP   = 4'd4,
        TB_DATATRAINCENTER2_PTR_TO_LINKSPEED    = 4'd5,
        TB_DATATRAINCENTER2_PTR_TO_TRAINERROR   = 4'd6
    } tb_partner_state_t;
    ...
    always @(posedge lclk or negedge rst_n) begin
        if (!rst_n) begin
            tb_prev_dut_local_state   <= TB_DATATRAINCENTER2_LCL_IDLE;
            tb_prev_dut_partner_state <= TB_DATATRAINCENTER2_PTR_IDLE;
        end else begin
    ...
    initial begin
        dut_if.state_n_0             = ltsm_state_n_pkg::LOG_MBTRAIN_DATATRAINCENTER2;
        ...
        ptn_if.state_n_0             = ltsm_state_n_pkg::LOG_MBTRAIN_DATATRAINCENTER2;
    ...
    task automatic tb_run_scenario(
        ...
        ptn_local_datatraincenter2_en = 1;
        dut_partner_datatraincenter2_en = 1;
        ...
        fork
            begin
                wait (dut_datatraincenter2_done || dut_trainerror_req);
                #(LCLK_PERIOD * 10);
            end
            begin
        ...
        if (expect_success) begin
            if (!dut_datatraincenter2_done || dut_trainerror_req) begin
        ...
        ptn_local_datatraincenter2_en = 0;
        dut_partner_datatraincenter2_en = 0;
