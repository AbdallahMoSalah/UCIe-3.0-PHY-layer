...
//  ucie_scoreboard
// -----------------------------------------------------------------------------
//  UVM Scoreboard utilizing TLM analysis FIFOs to compare Mainband and Sideband
//  cross-die transactions across Die 0 and Die 1 with concurrent comparison threads.
// =============================================================================
...
class ucie_scoreboard extends uvm_scoreboard;
  ...
  task compare_sb_die0_to_die1();
    ...
    forever begin
      ...
      if (tx_item.sb_pkt.payload === rx_item.sb_pkt.payload) begin
        match_count++;
