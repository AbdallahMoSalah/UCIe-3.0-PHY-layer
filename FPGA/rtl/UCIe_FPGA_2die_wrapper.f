# =============================================================================
# Listfile: UCIe_FPGA_2die_wrapper.f
...
# ---- Two-die cross-connect + fault injector ---------------------------------
FPGA/rtl/ucie_link_fault_injector.v
FPGA/rtl/UCIe_FPGA_2die_wrapper.v
