# =============================================================================
# Listfile: UCIe_FPGA_top_wrapper_fi.f
# Purpose : Top-level wrapper integrating four AXI-Stream bridges and the
#           UCIe_FPGA_loopback core into a single module for FPGA target.
# TOP     : UCIe_FPGA_top_wrapper_fi
# =============================================================================
...
# ---- SideBand digital/analog split -------------------------------------------
rtl/SideBand/sideband_analog_hard_macro.sv
rtl/SideBand/digital_sideband.sv
...
# ---- Top digital/analog split + wrapper under test ---------------------------
rtl/common/analog_hard_macro/analog_hard_macro.sv
rtl/TOP/digital_ucie.sv
rtl/TOP/UCIe_PHY_wrapper.sv

# ---- FPGA digital-only self-loopback wrapper ---------------------------------
FPGA/rtl/digital_ucie_link.sv

# ---- FPGA top wrapper and bridges --------------------------------------------
FPGA/rtl/axis_slave_to_mb_tx.sv
FPGA/rtl/axis_master_from_mb_rx.sv
FPGA/rtl/axis_slave_to_sb_cfg.sv
FPGA/rtl/axis_master_from_sb_cfg.sv
FPGA/rtl/UCIe_FPGA_link.v
FPGA/rtl/UCIe_FPGA_top_wrapper_link.v

# ---- Loopback self-fold fault injector + FI top ------------------------------
FPGA/rtl/ucie_loopback_fault_injector.v
FPGA/rtl/UCIe_FPGA_top_wrapper_fi.v
