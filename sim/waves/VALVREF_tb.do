...
add wave -noupdate -expand -group {Vref Calculation} /VALVREF_tb/VALVREF_inst/clk_sampling
add wave -noupdate -expand -group {Vref Calculation} /VALVREF_tb/VALVREF_inst/ltsm_if/successful_clk_sampling
...
add wave -noupdate -expand -group {Vref Calculation} -color Gold -itemcolor Gold -radix unsigned -childformat {{{/VALVREF_tb/VALVREF_inst/vref_range[2]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/vref_range[1]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/vref_range[0]} -radix unsigned}} -expand -subitemconfig {{/VALVREF_tb/VALVREF_inst/vref_range[2]} {-color Gold -itemcolor Gold -radix unsigned} {/VALVREF_tb/VALVREF_inst/vref_range[1]} {-color Gold -itemcolor Gold -radix unsigned} {/VALVREF_tb/VALVREF_inst/vref_range[0]} {-color Gold -itemcolor Gold -radix unsigned}} /VALVREF_tb/VALVREF_inst/vref_range
add wave -noupdate -expand -group {Vref Calculation} -color Cyan -itemcolor Cyan -radix unsigned -childformat {{{/VALVREF_tb/VALVREF_inst/min_vref_code[2]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/min_vref_code[1]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/min_vref_code[0]} -radix unsigned}} -expand -subitemconfig {{/VALVREF_tb/VALVREF_inst/min_vref_code[2]} {-color Cyan -itemcolor Cyan -radix unsigned} {/VALVREF_tb/VALVREF_inst/min_vref_code[1]} {-color Cyan -itemcolor Cyan -radix unsigned} {/VALVREF_tb/VALVREF_inst/min_vref_code[0]} {-color Cyan -itemcolor Cyan -radix unsigned}} /VALVREF_tb/VALVREF_inst/min_vref_code
add wave -noupdate -expand -group {Vref Calculation} -color Gold -itemcolor Gold -radix unsigned -childformat {{{/VALVREF_tb/VALVREF_inst/max_vref_code[2]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/max_vref_code[1]} -radix unsigned} {{/VALVREF_tb/VALVREF_inst/max_vref_code[0]} -radix unsigned}} -expand -subitemconfig {{/VALVREF_tb/VALVREF_inst/max_vref_code[2]} {-color Gold -itemcolor Gold -radix unsigned} {/VALVREF_tb/VALVREF_inst/max_vref_code[1]} {-color Gold -itemcolor Gold -radix unsigned} {/VALVREF_tb/VALVREF_inst/max_vref_code[0]} {-color Gold -itemcolor Gold -radix unsigned}} /VALVREF_tb/VALVREF_inst/max_vref_code
...
WaveRestoreCursors {{Cursor 1} {563496018 ps} 0} {{Cursor 2} {563338518 ps} 0}
quietly wave cursor active 1
configure wave -namecolwidth 295
configure wave -valuecolwidth 365
...
update
WaveRestoreZoom {563336388 ps} {563582489 ps}
