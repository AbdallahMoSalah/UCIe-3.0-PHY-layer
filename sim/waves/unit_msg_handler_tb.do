...
add wave -noupdate -divider {recieved msg}
add wave -noupdate -color green -itemcolor green /unit_msg_handler_tb/uut/Link_Mgmt_Msg_Recieved
...
add wave -noupdate -color violet -itemcolor violet /unit_msg_handler_tb/uut/Massage_send
add wave -noupdate -color violet -itemcolor violet /unit_msg_handler_tb/uut/Massage_recieve
