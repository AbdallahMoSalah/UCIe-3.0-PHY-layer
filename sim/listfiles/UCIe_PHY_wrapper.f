# =============================================================================
# Listfile: UCIe_PHY_wrapper.f
# Purpose : Integration TB for the digital/analog split PHY
#           UCIe_PHY_wrapper = digital_ucie + analog_hard_macro
#           (pin-identical to monolithic UCIe_PHY)
...
# ---- Testbench ---------------------------------------------------------------
tb/integration/UCIe_PHY/UCIe_PHY_wrapper_tb.sv
