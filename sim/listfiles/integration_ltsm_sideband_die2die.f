# =============================================================================
# Listfile: integration_ltsm_sideband_die2die.f
# Purpose : Two complete UCIe PHY dies wired back-to-back:
#             2x LTSM_TOP  +  2x SideBand_Top  +  2x unit_mb_die
#           Compile order: packages -> common utils -> SB RTL -> LTSM RTL ->
#                          MainBand RD RTL -> interface + LTSM_TOP -> TB
# =============================================================================
...
# ---- Testbench ---------------------------------------------------------------
tb/integration/LTSM_SideBand_MB/ltsm_sideband_die2die_tb.sv
