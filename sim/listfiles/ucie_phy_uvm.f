// =============================================================================
//  Listfile: ucie_phy_uvm.f
//  Purpose : Compile list for the digital/analog split PHY with UVM Testbench
//  TOP     : ucie_tb_top
// =============================================================================
...
// ---- Top digital/analog split + wrapper ----
rtl/common/analog_hard_macro/analog_hard_macro.sv
rtl/TOP/digital_ucie.sv
rtl/TOP/UCIe_PHY_wrapper.sv

// ---- UVM Interfaces, Packages, and Top ----
+incdir+tb/uvm/src
+incdir+tb/uvm/interfaces
tb/uvm/interfaces/ucie_ltsm_monitor_if.sv
