# =============================================================================
# Listfile: ucie_phy_loopback.f
# Purpose : Single-instance SELF-LOOPBACK of UCIe_PHY_wrapper (FPGA bring-up).
#           One PHY with its own TX lanes folded back into its own RX lanes.
# TOP     : ucie_phy_loopback_tb
# =============================================================================
...
# ---- FPGA self-loopback wrapper ----------------------------------------------
FPGA/rtl/ucie_phy_loopback.sv

# ---- Testbench ---------------------------------------------------------------
FPGA/tb/ucie_phy_loopback_tb.sv
