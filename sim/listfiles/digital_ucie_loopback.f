# =============================================================================
# Listfile: digital_ucie_loopback.f
# Purpose : Self-loopback of digital_ucie ALONE (NO ANALOG) - parallel boundary
#           folded back on itself.  Analog/SerDes/PLL files still compile but
#           are NOT instantiated (top = digital_ucie_loopback -> digital_ucie).
...
# ---- Testbench ---------------------------------------------------------------
FPGA/tb/digital_ucie_loopback_tb.sv
